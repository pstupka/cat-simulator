...
onready var _history = preload("res://addons/game_template/scenes/scenes_history.gd").new()
onready var _loader_ri = \
  preload("res://addons/game_template/scenes/resource_interactive_loader.gd").new()
onready var _loader_mt = \
  preload("res://addons/game_template/scenes/resource_multithread_loader.gd").new()
